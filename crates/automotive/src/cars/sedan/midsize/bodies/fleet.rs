...
pub fn entry() -> BodyKit {
    BodyKit {
        ...
        spoiler: Spoiler::fixed(SpoilerMaterial::ABS, 18.0, 1140.0),
...
pub fn fleet() -> BodyKit {
    BodyKit {
        ...
        fender_front: Fender::standard(PanelMaterial::Steel, 9.0),
        fender_rear: Fender::standard(PanelMaterial::Steel, 9.0),
        spoiler: Spoiler::fixed(SpoilerMaterial::ABS, 19.0, 1145.0),
        windshield: Windshield::acoustic(4.9),
