use crate::cars::blocs::{
    ...
    IcePowerpack,
    AutomaticGearbox, ManualGearbox, SequentialGearbox,
    Clutch, DryCutch,
    WheelBoltPattern,
    Rwd, Independent,
    DriveLayout,
    engines::gazolines::{
        v8::{biturbo as gaz_v8_bt, supercharged as gaz_v8_sc},
        v10::{biturbo as gaz_v10_bt, supercharged as gaz_v10_sc},
        v12::{biturbo as gaz_v12_bt, supercharged as gaz_v12_sc},
        v16::{biturbo as gaz_v16_bt, supercharged as gaz_v16_sc},
        w6::{biturbo as gaz_w6_bt, supercharged as gaz_w6_sc},
        w8::{biturbo as gaz_w8_bt, supercharged as gaz_w8_sc},
        w10::{biturbo as gaz_w10_bt, supercharged as gaz_w10_sc},
        w12::{biturbo as gaz_w12_bt, supercharged as gaz_w12_sc},
        w16::{biturbo as gaz_w16_bt, supercharged as gaz_w16_sc},
    },
};
...
fn v8_blocs() -> Vec<Bloc> {
    vec![
        gaz_v8_bt::v8_5_0_tp_g(),
        gaz_v8_sc::v8_5_0_rt_g(), gaz_v8_sc::v8_5_0_tw_g(), gaz_v8_sc::v8_5_0_cf_g(),
        gaz_v8_bt::v8_4_5_tp_g(),
        gaz_v8_sc::v8_4_5_rt_g(), gaz_v8_sc::v8_4_5_tw_g(), gaz_v8_sc::v8_4_5_cf_g(),
    ]
}

fn v10_blocs() -> Vec<Bloc> {
    vec![
        gaz_v10_bt::v10_5_0_tp_g(),
        gaz_v10_sc::v10_5_0_rt_g(), gaz_v10_sc::v10_5_0_tw_g(), gaz_v10_sc::v10_5_0_cf_g(),
        gaz_v10_bt::v10_5_2_tp_g(),
        gaz_v10_sc::v10_5_2_rt_g(), gaz_v10_sc::v10_5_2_tw_g(), gaz_v10_sc::v10_5_2_cf_g(),
    ]
}

fn v12_blocs() -> Vec<Bloc> {
    vec![
        gaz_v12_bt::v12_6_5_tp_g(),
        gaz_v12_sc::v12_6_5_rt_g(), gaz_v12_sc::v12_6_5_tw_g(), gaz_v12_sc::v12_6_5_cf_g(),
        gaz_v12_bt::v12_6_0_tp_g(),
        gaz_v12_sc::v12_6_0_rt_g(), gaz_v12_sc::v12_6_0_tw_g(), gaz_v12_sc::v12_6_0_cf_g(),
    ]
}

fn v16_blocs() -> Vec<Bloc> {
    vec![
        gaz_v16_bt::v16_8_0_tp_g(),
        gaz_v16_sc::v16_8_0_rt_g(), gaz_v16_sc::v16_8_0_tw_g(), gaz_v16_sc::v16_8_0_cf_g(),
    ]
}

fn w6_blocs() -> Vec<Bloc> {
    vec![
        gaz_w6_bt::w6_3_6_tp_g(),
...
fn w16_blocs() -> Vec<Bloc> {
    vec![
        gaz_w16_bt::w16_8_0_tp_g(),
        gaz_w16_sc::w16_8_0_rt_g(), gaz_w16_sc::w16_8_0_tw_g(), gaz_w16_sc::w16_8_0_cf_g(),
    ]
}
