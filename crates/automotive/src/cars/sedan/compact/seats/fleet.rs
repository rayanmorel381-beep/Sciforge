use crate::components::seats::{BenchConfig, BenchSeat, ComfortFeature, ComfortSeat};
...
pub fn fleet() -> SeatKit {
    SeatKit {
        front_left: ComfortSeat { features: vec![ComfortFeature::Heated], memory_positions: 0, lumbar_support: true, extendable_thigh: false },
        front_right: ComfortSeat { features: vec![ComfortFeature::Heated], memory_positions: 0, lumbar_support: true, extendable_thigh: false },
        rear: BenchSeat::foldable(BenchConfig::Split60_40),
    }
}
