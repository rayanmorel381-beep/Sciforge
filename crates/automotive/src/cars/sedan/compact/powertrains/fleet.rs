use crate::components::powertrain::{
    ...
    transmissions::{
        assemblies::{automatics::AutomaticGearbox, manuals::ManualGearbox, robotized::{RobotizedManual, with_latency}},
        clutches::{Clutch, DryCutch},
        drivelines::hubs::WheelBoltPattern,
        drivingwheels::{front::{Fwd, Longitudinal, Transverse}, DriveLayout},
    },
};
use crate::cars::blocs::engines::{
    diesels::{
        i4::turbo as diesel_i4_turbo,
        i5::turbo as diesel_i5_turbo,
        i6::{supercharged as diesel_i6_sc, turbo as diesel_i6_turbo},
        v6::turbo as diesel_v6_turbo,
    },
    gazolines::{
        i4::turbo as gaz_i4_turbo,
        i5::turbo as gaz_i5_turbo,
        i6::{supercharged as gaz_i6_sc, turbo as gaz_i6_turbo},
...
fn fleet_6speed_at() -> AutomaticGearbox {
    AutomaticGearbox::torque_converter(
        vec![(13, 48), (15, 42), (18, 38), (21, 34), (24, 30), (27, 27)],
        (11, 38),
    )
}
...
fn build_at_longitudinal(engine: Engine, gearbox: AutomaticGearbox) -> IcePowerpack {
    let input_torque = gearbox.max_input_torque_nm;
    let max_speed = engine.rpm_max;
    let spec = fwd_longitudinal_spec(input_torque, max_speed);
...
fn diesel_i4_blocs() -> Vec<Bloc> {
    vec![
        diesel_i4_turbo::i4_1_0_ss_d(), diesel_i4_turbo::i4_1_0_ts_d(), diesel_i4_turbo::i4_1_0_vg_d(),
        diesel_i4_turbo::i4_1_1_ss_d(), diesel_i4_turbo::i4_1_1_ts_d(), diesel_i4_turbo::i4_1_1_vg_d(),
        diesel_i4_turbo::i4_1_2_ss_d(), diesel_i4_turbo::i4_1_2_ts_d(), diesel_i4_turbo::i4_1_2_vg_d(),
        diesel_i4_turbo::i4_1_3_ss_d(), diesel_i4_turbo::i4_1_3_ts_d(), diesel_i4_turbo::i4_1_3_vg_d(),
        diesel_i4_turbo::i4_1_4_ss_d(), diesel_i4_turbo::i4_1_4_ts_d(), diesel_i4_turbo::i4_1_4_vg_d(),
    ]
}

fn diesel_i5_blocs() -> Vec<Bloc> {
    vec![
        diesel_i5_turbo::i5_2_0_ss_d(), diesel_i5_turbo::i5_2_0_ts_d(), diesel_i5_turbo::i5_2_0_vg_d(),
        diesel_i5_turbo::i5_2_1_ss_d(), diesel_i5_turbo::i5_2_1_ts_d(), diesel_i5_turbo::i5_2_1_vg_d(),
    ]
}

fn diesel_i6_blocs() -> Vec<Bloc> {
    vec![
        diesel_i6_turbo::i6_3_5_ss_d(), diesel_i6_turbo::i6_3_5_ts_d(), diesel_i6_turbo::i6_3_5_vg_d(),
        diesel_i6_sc::i6_3_5_rt_d(),    diesel_i6_sc::i6_3_5_tw_d(),    diesel_i6_sc::i6_3_5_cf_d(),
        diesel_i6_turbo::i6_2_8_ss_d(), diesel_i6_turbo::i6_2_8_ts_d(), diesel_i6_turbo::i6_2_8_vg_d(),
        diesel_i6_sc::i6_2_8_rt_d(),    diesel_i6_sc::i6_2_8_tw_d(),    diesel_i6_sc::i6_2_8_cf_d(),
    ]
}
...
pub fn gasoline() -> Vec<IcePowerpack> {
    ...
    for engine in expand_engines(gaz_v6_blocs(), Fuel::Gasoline) {
        result.push(build_at_longitudinal(engine.clone(), fleet_6speed_at()));
    }
    result
}
...
pub fn diesel() -> Vec<IcePowerpack> {
    let mut result = Vec::new();
    for engine in expand_engines(diesel_i4_blocs(), Fuel::Diesel) {
        result.push(build_manual_transverse(engine.clone(), fleet_5speed_manual()));
        result.push(build_manual_transverse(engine, fleet_6speed_manual()));
    }
    for engine in expand_engines(diesel_i5_blocs(), Fuel::Diesel) {
        result.push(build_manual_transverse(engine.clone(), fleet_5speed_manual()));
        result.push(build_manual_transverse(engine, fleet_6speed_manual()));
    }
    for engine in expand_engines(diesel_i6_blocs(), Fuel::Diesel) {
        result.push(build_robotized_longitudinal(engine.clone(), with_latency(ManualGearbox::six_speed(
            vec![(13, 52), (16, 46), (19, 42), (22, 38), (26, 34), (30, 30)],
            (11, 42),
        ), engine.bloc.displacement_cc as f64 / 1000.0)));
