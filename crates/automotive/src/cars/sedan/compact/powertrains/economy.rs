...
const FRONT_TRACK_MM: f64 = 1500.0;
const REAR_TRACK_MM: f64 = 1490.0;
const WHEELBASE_MM: f64 = 2600.0;
const GEARBOX_TO_REAR_AXLE_MM: f64 = 1950.0;
...
fn diesel_i3_blocs() -> Vec<Bloc> {
    vec![
        diesel_i3_turbo::i3_0_6_ss_d(), diesel_i3_turbo::i3_0_6_ts_d(), diesel_i3_turbo::i3_0_6_vg_d(),
        diesel_i3_turbo::i3_0_7_ss_d(), diesel_i3_turbo::i3_0_7_ts_d(), diesel_i3_turbo::i3_0_7_vg_d(),
        diesel_i3_turbo::i3_0_8_ss_d(), diesel_i3_turbo::i3_0_8_ts_d(), diesel_i3_turbo::i3_0_8_vg_d(),
        diesel_i3_turbo::i3_0_9_ss_d(), diesel_i3_turbo::i3_0_9_ts_d(), diesel_i3_turbo::i3_0_9_vg_d(),
        diesel_i3_turbo::i3_1_0_ss_d(), diesel_i3_turbo::i3_1_0_ts_d(), diesel_i3_turbo::i3_1_0_vg_d(),
    ]
}
...
pub fn diesel() -> Vec<IcePowerpack> {
    let inline_blocs: Vec<Bloc> = diesel_i3_blocs()
        .into_iter()
        .chain(diesel_i4_blocs())
        .chain(diesel_i5_blocs())
        .collect();
    let v_blocs: Vec<Bloc> = diesel_v6_blocs()
        .into_iter()
        .chain(diesel_v8_blocs())
        .collect();
    let mut result: Vec<IcePowerpack> = expand_engines(inline_blocs, Fuel::Diesel)
        .into_iter()
        .map(|engine| build_ice_fwd(engine, economy_cvt()))
        .collect();
    result.extend(
