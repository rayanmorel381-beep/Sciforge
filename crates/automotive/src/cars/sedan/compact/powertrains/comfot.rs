use crate::components::powertrain::{
    ...
    transmissions::{
        assemblies::automatics::AutomaticGearbox,
        drivelines::hubs::WheelBoltPattern,
        drivingwheels::{alls::{Awd, FullTime}, DriveLayout},
    },
};
use crate::cars::blocs::engines::{
    diesels::{
        i6::{supercharged as diesel_i6_sc, turbo as diesel_i6_turbo},
        v6::{supercharged as diesel_v6_sc, turbo as diesel_v6_turbo},
        v8::{supercharged as diesel_v8_sc, turbo as diesel_v8_turbo},
    },
    gazolines::{
        i6::{supercharged as gaz_i6_sc, turbo as gaz_i6_turbo},
        v6::{supercharged as gaz_v6_sc, turbo as gaz_v6_turbo},
        v8::{supercharged as gaz_v8_sc, turbo as gaz_v8_turbo},
        vr6::{supercharged as gaz_vr6_sc, turbo as gaz_vr6_turbo},
        vr8::{supercharged as gaz_vr8_sc, turbo as gaz_vr8_turbo},
        w6::{supercharged as gaz_w6_sc, turbo as gaz_w6_turbo},
        w8::{supercharged as gaz_w8_sc, turbo as gaz_w8_turbo},
        w10::{supercharged as gaz_w10_sc, turbo as gaz_w10_turbo},
        w12::{supercharged as gaz_w12_sc, turbo as gaz_w12_turbo},
    },
};
...
fn diesel_i6_blocs() -> Vec<Bloc> {
    vec![
        ...
        diesel_i6_turbo::i6_3_2_ss_d(), diesel_i6_turbo::i6_3_2_ts_d(), diesel_i6_turbo::i6_3_2_vg_d(),
        diesel_i6_sc::i6_3_2_rt_d(),    diesel_i6_sc::i6_3_2_tw_d(),    diesel_i6_sc::i6_3_2_cf_d(),
        diesel_i6_turbo::i6_3_0_ss_d(), diesel_i6_turbo::i6_3_0_ts_d(), diesel_i6_turbo::i6_3_0_vg_d(),
        diesel_i6_sc::i6_3_0_rt_d(),    diesel_i6_sc::i6_3_0_tw_d(),    diesel_i6_sc::i6_3_0_cf_d(),
        ...
        diesel_i6_turbo::i6_2_5_ss_d(), diesel_i6_turbo::i6_2_5_ts_d(), diesel_i6_turbo::i6_2_5_vg_d(),
        diesel_i6_sc::i6_2_5_rt_d(),    diesel_i6_sc::i6_2_5_tw_d(),    diesel_i6_sc::i6_2_5_cf_d(),
    ]
}
