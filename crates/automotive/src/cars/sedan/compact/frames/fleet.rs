...
pub fn fleet() -> FrameKit {
    FrameKit {
        unibody: Unibody::steel(SteelGrade::HighStrength, 18000.0, 260.0),
        crumple_front: CrumpleZone::front(85.0),
        crumple_rear: CrumpleZone::rear(52.0),
        crumple_side_left: CrumpleZone::side(30.0),
        crumple_side_right: CrumpleZone::side(30.0),
    }
}
