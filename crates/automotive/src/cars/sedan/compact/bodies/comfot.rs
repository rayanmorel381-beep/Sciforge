...
pub fn entry() -> BodyKit {
    BodyKit {
        ...
        spoiler: Spoiler::fixed(SpoilerMaterial::ABS, 18.0, 1100.0),
...
pub fn comfort() -> BodyKit {
    BodyKit {
        ...
        fender_front: Fender::standard(PanelMaterial::Steel, 8.5),
        fender_rear: Fender::standard(PanelMaterial::Steel, 8.5),
        spoiler: Spoiler::fixed(SpoilerMaterial::ABS, 20.0, 1110.0),
        windshield: Windshield::acoustic(4.8),
        side_window: SideWindow::tinted(3.7),
        rear_window: RearWindow::with_wiper(3.8),
    }
}
...
pub fn premium() -> BodyKit {
    BodyKit {
        hood: Hood::aluminum(13.0),
        roof: Roof::panoramic(28.0),
        trunk: Trunk::power_liftgate(PanelMaterial::Steel, 16.0),
        door_fl: Door::conventional(PanelMaterial::Steel, false, 21.0),
        door_fr: Door::conventional(PanelMaterial::Steel, false, 21.0),
        door_rl: Door::conventional(PanelMaterial::Steel, false, 19.0),
        door_rr: Door::conventional(PanelMaterial::Steel, false, 19.0),
        fender_front: Fender::standard(PanelMaterial::Aluminum, 7.5),
        fender_rear: Fender::standard(PanelMaterial::Aluminum, 7.5),
        spoiler: Spoiler::fixed(SpoilerMaterial::ABS, 22.0, 1115.0),
        windshield: Windshield::acoustic(4.8),
        side_window: SideWindow::tinted(3.7),
