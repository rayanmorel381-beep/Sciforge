...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() >= 4.1 {
        SoundCharacter::W8Sport
    } else if d.liters() >= 3.9 {
        SoundCharacter::W8Passat
    } else {
        SoundCharacter::W8Smooth
    }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::W8Burble => VoiceLoudness::VrBurble,
        ExhaustVoice::W8Sport => VoiceLoudness::Sporty,
