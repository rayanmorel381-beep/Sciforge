...
pub enum SoundCharacter { W10Smooth, W10Howl, W10Sport, Aggressive, Race }
...
pub enum ExhaustVoice {
    Muffled, Sporty, Aggressive, Race, W10Howl, W10Sport, LuxuryHum,
}
...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() >= 5.3 { SoundCharacter::W10Sport }
    else if d.liters() >= 4.8 { SoundCharacter::W10Howl }
    else { SoundCharacter::W10Smooth }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::W10Howl => VoiceLoudness::W8Smooth,
        ExhaustVoice::W10Sport => VoiceLoudness::W8Smooth,
