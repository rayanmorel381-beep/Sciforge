...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 6.2 {
        SoundCharacter::W12Symphony
    } else if liters >= 5.8 {
        SoundCharacter::W12Howl
    } else {
        SoundCharacter::W12Smooth
    }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::W12Howl => VoiceLoudness::W8Smooth,
        ExhaustVoice::W12Symphony => VoiceLoudness::LuxuryHum,
