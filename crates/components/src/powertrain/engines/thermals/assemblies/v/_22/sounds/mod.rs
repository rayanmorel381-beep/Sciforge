...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 14.0 {
        SoundCharacter::V22Thunder
    } else if liters >= 12.0 {
        SoundCharacter::V22Symphony
    } else if liters >= 10.5 {
        SoundCharacter::V22Colossus
    } else {
        SoundCharacter::Smooth
    }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V22Colossus => VoiceLoudness::CrossPlane,
        ExhaustVoice::V22Symphony => VoiceLoudness::LuxuryHum,
        ExhaustVoice::V22Thunder => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V22Thunder),
        turbo_spool_hz: None,
