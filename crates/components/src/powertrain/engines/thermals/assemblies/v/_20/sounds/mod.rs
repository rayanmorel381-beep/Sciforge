...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 13.0 {
        SoundCharacter::V20Thunder
    } else if liters >= 11.0 {
        SoundCharacter::V20Symphony
    } else if liters >= 9.5 {
        SoundCharacter::V20Roar
    } else {
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V20Roar => VoiceLoudness::CrossPlane,
        ExhaustVoice::V20Symphony => VoiceLoudness::LuxuryHum,
        ExhaustVoice::V20Thunder => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V20Thunder),
        turbo_spool_hz: None,
