...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 15.0 {
        SoundCharacter::V24Thunder
    } else if liters >= 13.0 {
        SoundCharacter::V24Symphony
    } else if liters >= 11.5 {
        SoundCharacter::V24Titan
    } else {
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V24Titan => VoiceLoudness::CrossPlane,
        ExhaustVoice::V24Symphony => VoiceLoudness::LuxuryHum,
        ExhaustVoice::V24Thunder => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V24Thunder),
        turbo_spool_hz: None,
