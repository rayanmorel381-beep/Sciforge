...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() < 5.0 {
        SoundCharacter::F1Scream
    } else if d.liters() < 6.0 {
        SoundCharacter::V10Wail
    } else if d.liters() >= 8.0 {
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V10Wail => VoiceLoudness::Race,
        ExhaustVoice::F1Scream => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V10Wail | ExhaustVoice::F1Scream),
        turbo_spool_hz: None,
