...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 10.0 {
        SoundCharacter::V16Thunder
    } else if liters >= 7.5 {
        SoundCharacter::V16Symphony
    } else if liters >= 6.5 {
        SoundCharacter::V16Wail
    } else {
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V16Wail => VoiceLoudness::CrossPlane,
        ExhaustVoice::V16Symphony => VoiceLoudness::LuxuryHum,
        ExhaustVoice::V16Thunder => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V16Thunder),
        turbo_spool_hz: None,
