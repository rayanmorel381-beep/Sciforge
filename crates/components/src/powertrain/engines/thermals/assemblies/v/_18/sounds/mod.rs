...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    let liters = d.liters();
    if liters >= 12.0 {
        SoundCharacter::V18Thunder
    } else if liters >= 9.5 {
        SoundCharacter::V18Symphony
    } else if liters >= 8.0 {
        SoundCharacter::V18Scream
    } else {
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::V18Scream => VoiceLoudness::CrossPlane,
        ExhaustVoice::V18Symphony => VoiceLoudness::LuxuryHum,
        ExhaustVoice::V18Thunder => VoiceLoudness::Race,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::V18Thunder),
        turbo_spool_hz: None,
