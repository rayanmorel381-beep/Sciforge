...
pub enum SoundCharacter { VR8Distinctive, VR8Sport, Aggressive, Race }
...
pub enum ExhaustVoice {
    Muffled, Sporty, Aggressive, Race, VR8Burble, VR8Sport, LuxuryHum,
}
...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() >= 4.3 { SoundCharacter::VR8Sport } else { SoundCharacter::VR8Distinctive }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::VR8Burble => VoiceLoudness::VrBurble,
        ExhaustVoice::VR8Sport => VoiceLoudness::VrBurble,
