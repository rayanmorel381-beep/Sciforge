...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() >= 1.8 { SoundCharacter::VR4Burble } else { SoundCharacter::VR4Smooth }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::VR4Burble => VoiceLoudness::VrBurble,
        ExhaustVoice::VR4Sport => VoiceLoudness::VrBurble,
