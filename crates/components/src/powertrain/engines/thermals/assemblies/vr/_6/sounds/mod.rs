...
pub enum SoundCharacter { VR6Smooth, VR6Burble, VR6Sport, Aggressive, Race }
...
pub enum ExhaustVoice {
    Muffled, Sporty, Aggressive, Race, VR6Burble, VR6Sport, LuxuryHum,
}
...
pub fn character_for(d: &Displacement) -> SoundCharacter {
    if d.liters() >= 3.5 { SoundCharacter::VR6Sport }
    else if d.liters() >= 3.1 { SoundCharacter::VR6Burble }
    else { SoundCharacter::VR6Smooth }
}
...
fn voice_loudness(exhaust: ExhaustVoice) -> VoiceLoudness {
    match exhaust {
        ...
        ExhaustVoice::VR6Burble => VoiceLoudness::VrBurble,
        ExhaustVoice::VR6Sport => VoiceLoudness::VrBurble,
...
pub fn natural(d: &Displacement, exhaust: ExhaustVoice) -> EngineSound {
    ...
    EngineSound {
        ...
        crackle_pop: matches!(exhaust, ExhaustVoice::Aggressive | ExhaustVoice::Race | ExhaustVoice::VR6Burble),
        turbo_spool_hz: None,
