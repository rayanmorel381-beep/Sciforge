...
use sciforge_lib::constants::astronomy::{EARTH_GRAVITY, EARTH_RADIUS};
use sciforge_lib::constants::geology::{HEAT_PRODUCTION_K40, HEAT_PRODUCTION_TH232, HEAT_PRODUCTION_U238};
use sciforge_lib::constants::physics::{G, MU_0, SIGMA_SB};
