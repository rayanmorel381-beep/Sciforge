...
pub static GEAR_OIL_75W140: LazyLock<Liquid> = LazyLock::new(|| Liquid {
    name: "Gear Oil SAE 75W-140",
    formula: "Hydrocarbon+EP additives",
    family: LiquidFamily::Oil,
    density_kg_m3_ref: 886.0,
    dynamic_viscosity_pa_s_ref: 0.265,
    bulk_modulus_pa: 1.76e9,
    specific_heat_j_kgk: 2030.0,
    thermal_conductivity_w_mk: 0.138,
    surface_tension_n_m: 0.032,
    vapor_pressure_pa_ref: 32.0,
