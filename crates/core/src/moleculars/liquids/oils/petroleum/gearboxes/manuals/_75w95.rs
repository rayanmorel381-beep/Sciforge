...
pub static GEAR_OIL_75W95: LazyLock<Liquid> = LazyLock::new(|| Liquid {
    name: "Gear Oil SAE 75W-95",
    formula: "Hydrocarbon+EP additives",
    family: LiquidFamily::Oil,
    density_kg_m3_ref: 873.0,
    dynamic_viscosity_pa_s_ref: 0.153,
