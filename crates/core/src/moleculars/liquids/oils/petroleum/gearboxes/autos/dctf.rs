...
pub static AUTOMATIC_TRANS_FLUID_DCTF: LazyLock<Liquid> = LazyLock::new(|| Liquid {
    name: "DCTF",
    formula: "Hydrocarbon+friction modifiers",
    family: LiquidFamily::Oil,
    density_kg_m3_ref: 846.0,
    dynamic_viscosity_pa_s_ref: 0.036,
    bulk_modulus_pa: 1.66e9,
    specific_heat_j_kgk: 2048.0,
    thermal_conductivity_w_mk: 0.141,
    surface_tension_n_m: 0.029,
    vapor_pressure_pa_ref: 54.0,
