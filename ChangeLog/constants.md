...
### Removed — `constants::maths::approximation`

| Constant | Reason |
|---|---|
| `pub const SPEED_OF_LIGHT_KM_S: f64` | Duplicate alias of `C_KM_S` — callers now import `C_KM_S` directly from `constants::astronomy::astro` |
